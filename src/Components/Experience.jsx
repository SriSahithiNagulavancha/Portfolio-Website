  ...
  return (
    <section id="experience" className="py-16 sm:py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative mt-10 border-l border-white/10 pl-8 light:border-slate-200">
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur-sm transition duration-300 hover:border-cyan-400/20 hover:shadow-[0_20px_60px_rgba(34,211,238,0.12)] light:border-slate-200 light:bg-white light:hover:shadow-[0_20px_60px_rgba(14,165,233,0.08)]">
